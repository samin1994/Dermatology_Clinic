...
می‌تواند باعث ایجاد ظاهری جوان‌تر و درخشان‌تر شود. کلاژن پروتئینی است که به طور طبیعی توسط بدن تولید می‌شود و
 ...
 و افتادگی پوست می‌شود. هایفو می‌تواند با تحریک تولید الیاف کلاژن و الاستین جدید به معکوس کردن این فرآیند کمک کند.`,
                ...
                {
                    content: `از کاربردهای مهم هایفوتراپی می‌توانیم به درمان
                     افتادگی پلک اشاره کنیم. پلک‌ها که معمولا با گذر زمان، دچار
                     افتادگی و چین‌وچروک می‌شوند، تاثیر زیادی در زیبایی دارند. هایفوتراپی با تاباندن
                     امواج فراصوت می‌تواند پلک‌ها را لیفت کرده و با تولید کلاژن جوانی را به چهره بازگرداند.`,
